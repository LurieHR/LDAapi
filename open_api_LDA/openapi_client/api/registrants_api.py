...
class RegistrantsApi:
    ...
    def list_registrants(
        ...
        id: Annotated[Optional[StrictInt], Field(description="ID")] = None,
        registrant_name: Annotated[Optional[StrictStr], Field(description="Name")] = None,
        ...
        ppb_country: Annotated[Optional[StrictStr], Field(description="PPB Country")] = None,
        dt_updated_after: Annotated[Optional[datetime], Field(description="Date Update Range (Before / After): yyyy-mm-dd")] = None,
        dt_updated_before: Annotated[Optional[datetime], Field(description="Date Update Range (Before / After): yyyy-mm-dd")] = None,
        ...
        :param id: ID
        :type id: int
        :param registrant_name: Name
        :type registrant_name: str
        :param state: State
        :type state: str
        :param country: Country
        :type country: str
        :param ppb_country: PPB Country
        :type ppb_country: str
        :param dt_updated_after: Date Update Range (Before / After): yyyy-mm-dd
        :type dt_updated_after: datetime
        :param dt_updated_before: Date Update Range (Before / After): yyyy-mm-dd
        :type dt_updated_before: datetime
        ...
        _param = self._list_registrants_serialize(
            page=page,
            page_size=page_size,
            ordering=ordering,
            id=id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListRegistrants200Response",
            '400': "Error",
            '401': "Error",
            '404': "Error",
            '405': "Error",
    ...
    @validate_call
    def list_registrants_with_http_info(
        self,
        page: Annotated[Optional[StrictInt], Field(description="A page number within the paginated result set.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Number of results to return per page.")] = None,
        ordering: Annotated[Optional[StrictStr], Field(description="Which field to use when ordering the results.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListRegistrants200Response]:
        """list_registrants
    ...
    @validate_call
    def list_registrants_without_preload_content(
        self,
        page: Annotated[Optional[StrictInt], Field(description="A page number within the paginated result set.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Number of results to return per page.")] = None,
        ordering: Annotated[Optional[StrictStr], Field(description="Which field to use when ordering the results.")] = None,
    ...
    def _list_registrants_serialize(
        self,
        page,
        page_size,
        ordering,
        ...
        if ppb_country is not None:
            
            _query_params.append(('ppb_country', ppb_country))
            
        if dt_updated_after is not None:
            if isinstance(dt_updated_after, datetime):
                _query_params.append(
                    (
                        'dt_updated_after',
                        dt_updated_after.strftime(
                            self.api_client.configuration.datetime_format
                        )
                    )
                )
            else:
                _query_params.append(('dt_updated_after', dt_updated_after))
            
        if dt_updated_before is not None:
            if isinstance(dt_updated_before, datetime):
                _query_params.append(
                    (
                        'dt_updated_before',
                        dt_updated_before.strftime(
                            self.api_client.configuration.datetime_format
                        )
                    )
                )
            else:
                _query_params.append(('dt_updated_before', dt_updated_before))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/registrants/',
    ...
    def retrieve_registrant(
        self,
        id: Annotated[StrictInt, Field(description="A unique integer value identifying this Registrant.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: A unique integer value identifying this Registrant. (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._retrieve_registrant_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def retrieve_registrant_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="A unique integer value identifying this Registrant.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def retrieve_registrant_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="A unique integer value identifying this Registrant.")],
        _request_timeout: Union[
            None,
    ...
    def _retrieve_registrant_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/registrants/{id}/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
