...
class FilingClient(BaseModel):
    ...
    general_description: Optional[StrictStr] = None
    client_government_entity: Optional[StrictBool] = None
    client_self_select: Optional[StrictBool] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "url", "client_id", "name", "general_description", "client_government_entity", "client_self_select", "state", "state_display", "country", "country_display", "ppb_state", "ppb_state_display", "ppb_country", "ppb_country_display", "effective_date"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if general_description (nullable) is None
        # and model_fields_set contains the field
        if self.general_description is None and "general_description" in self.model_fields_set:
            _dict['general_description'] = None

        # set to None if client_government_entity (nullable) is None
        # and model_fields_set contains the field
        if self.client_government_entity is None and "client_government_entity" in self.model_fields_set:
            _dict['client_government_entity'] = None

        # set to None if client_self_select (nullable) is None
        # and model_fields_set contains the field
        if self.client_self_select is None and "client_self_select" in self.model_fields_set:
            _dict['client_self_select'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "client_government_entity": obj.get("client_government_entity"),
            "client_self_select": obj.get("client_self_select"),
            "state": obj.get("state"),
