...
class ContributionReportContributionItemsInner(BaseModel):
    """
    ContributionReportContributionItemsInner
    """ # noqa: E501
    contribution_type: Optional[StrictStr] = None
    contribution_type_display: Optional[StrictStr] = None
    contributor_name: Optional[StrictStr] = None
    payee_name: Optional[StrictStr] = None
    honoree_name: Optional[StrictStr] = None
    amount: Optional[Annotated[str, Field(strict=True)]] = None
    var_date: Optional[date] = Field(default=None, alias="date")
    __properties: ClassVar[List[str]] = ["contribution_type", "contribution_type_display", "contributor_name", "payee_name", "honoree_name", "amount", "date"]
    ...
    def contribution_type_validate_enum(cls, value):
        ...
        if value not in set(['feca', 'he', 'me', 'ple', 'pic']):
            raise ValueError("must be one of enum values ('feca', 'he', 'me', 'ple', 'pic')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contribution_type_display": obj.get("contribution_type_display"),
            "contributor_name": obj.get("contributor_name"),
            "payee_name": obj.get("payee_name"),
            "honoree_name": obj.get("honoree_name"),
