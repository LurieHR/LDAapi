...
class Client(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "url", "client_id", "name", "general_description", "client_government_entity", "client_self_select", "state", "state_display", "country", "country_display", "ppb_state", "ppb_state_display", "ppb_country", "ppb_country_display", "effective_date", "registrant"]
