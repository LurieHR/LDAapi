...
class FilingLobbyingActivitiesInnerLobbyistsInnerLobbyist(BaseModel):
    """
    FilingLobbyingActivitiesInnerLobbyistsInnerLobbyist
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "prefix", "prefix_display", "first_name", "nickname", "middle_name", "last_name", "suffix", "suffix_display"]
