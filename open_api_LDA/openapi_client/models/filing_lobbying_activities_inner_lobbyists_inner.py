...
class FilingLobbyingActivitiesInnerLobbyistsInner(BaseModel):
    """
    FilingLobbyingActivitiesInnerLobbyistsInner
    """ # noqa: E501
    lobbyist: Optional[FilingLobbyingActivitiesInnerLobbyistsInnerLobbyist] = None
    covered_position: Optional[StrictStr] = None
    new: Optional[StrictBool] = Field(default=None, description="None indicates no data available.")
    __properties: ClassVar[List[str]] = ["lobbyist", "covered_position", "new"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if covered_position (nullable) is None
        # and model_fields_set contains the field
        if self.covered_position is None and "covered_position" in self.model_fields_set:
            _dict['covered_position'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "covered_position": obj.get("covered_position"),
            "new": obj.get("new")
        })
        return _obj
