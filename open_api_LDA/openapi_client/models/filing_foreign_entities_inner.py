...
class FilingForeignEntitiesInner(BaseModel):
    """
    FilingForeignEntitiesInner
    """ # noqa: E501
    name: Optional[StrictStr] = None
    contribution: Optional[Annotated[str, Field(strict=True)]] = None
    ownership_percentage: Optional[Annotated[str, Field(strict=True)]] = None
    ...
    __properties: ClassVar[List[str]] = ["name", "contribution", "ownership_percentage", "address", "city", "state", "state_display", "country", "country_display", "ppb_city", "ppb_state", "ppb_state_display", "ppb_country", "ppb_country_display"]
