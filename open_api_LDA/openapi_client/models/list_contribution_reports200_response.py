...
class ListContributionReports200Response(BaseModel):
    """
    ...
    results: Optional[List[ContributionReport]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [ContributionReport.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
