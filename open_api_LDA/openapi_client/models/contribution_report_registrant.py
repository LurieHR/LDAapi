...
class ContributionReportRegistrant(BaseModel):
    """
    ContributionReportRegistrant
    """ # noqa: E501
    id: Optional[StrictInt] = None
    url: Optional[StrictStr] = None
    house_registrant_id: Optional[StrictInt] = None
    ...
    contact_telephone: Optional[StrictStr] = None
    dt_updated: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["id", "url", "house_registrant_id", "name", "description", "address_1", "address_2", "address_3", "address_4", "city", "state", "state_display", "zip", "country", "country_display", "ppb_country", "ppb_country_display", "contact_name", "contact_telephone", "dt_updated"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if house_registrant_id (nullable) is None
        # and model_fields_set contains the field
        if self.house_registrant_id is None and "house_registrant_id" in self.model_fields_set:
            _dict['house_registrant_id'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "url": obj.get("url"),
            "house_registrant_id": obj.get("house_registrant_id"),
            "name": obj.get("name"),
            ...
            "contact_telephone": obj.get("contact_telephone"),
            "dt_updated": obj.get("dt_updated")
        })
        return _obj
