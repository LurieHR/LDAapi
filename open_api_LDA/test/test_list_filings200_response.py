...
class TestListFilings200Response(unittest.TestCase):
    """ListFilings200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListFilings200Response:
        """Test ListFilings200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListFilings200Response`
        """
        model = ListFilings200Response()
        if include_optional:
            return ListFilings200Response(
                count = 123,
                next = '/api/v1/{operation}/?page=2',
                previous = '',
                results = [
                    openapi_client.models.filing.Filing(
                        url = '', 
                        filing_uuid = '', 
                        filing_type = 'RR', 
                        filing_type_display = '', 
                        ...
                        posted_by_name = '', 
                        dt_posted = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        ...
                        registrant_state = 'AL', 
                        registrant_zip = '', 
                        registrant = openapi_client.models.filing_registrant.Filing_registrant(
                            id = 56, 
                            url = '', 
                            house_registrant_id = 56, 
                            name = '', 
                            description = '', 
                            address_1 = '', 
                            address_2 = '', 
                            ...
                            contact_name = '', 
                            contact_telephone = '', 
                            dt_updated = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ), 
                        client = openapi_client.models.filing_client.Filing_client(
                            id = 56, 
                            url = '', 
                            client_id = '', 
                            name = '', 
                        ...
                        lobbying_activities = [
                            openapi_client.models.filing_lobbying_activities_inner.Filing_lobbying_activities_inner(
                                general_issue_code = 'ACC', 
                                general_issue_code_display = '', 
                                description = '', 
                                foreign_entity_issues = '', 
                                lobbyists = [
                                    openapi_client.models.filing_lobbying_activities_inner_lobbyists_inner.Filing_lobbying_activities_inner_lobbyists_inner(
                                        lobbyist = openapi_client.models.filing_lobbying_activities_inner_lobbyists_inner_lobbyist.Filing_lobbying_activities_inner_lobbyists_inner_lobbyist(
                                            id = 56, 
                                            prefix = 'dr', 
                                            prefix_display = '', 
                                            first_name = '', 
                                ...
                                government_entities = [
                                    openapi_client.models.filing_lobbying_activities_inner_government_entities_inner.Filing_lobbying_activities_inner_government_entities_inner(
                                        id = 56, 
                                        name = '', )
                                    ], )
                            ], 
                        conviction_disclosures = [
                            openapi_client.models.filing_conviction_disclosures_inner.Filing_conviction_disclosures_inner(
                                date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                                description = '', )
                            ], 
                        foreign_entities = [
                            openapi_client.models.filing_foreign_entities_inner.Filing_foreign_entities_inner(
                                name = '', 
                                contribution = '', 
                        ...
                        affiliated_organizations = [
                            openapi_client.models.filing_affiliated_organizations_inner.Filing_affiliated_organizations_inner(
                                name = '', 
                                url = 'e5otgfww9r63cm-fyln8uy://[64a9.236e3ae7.726228062401:e598fbb6c.30b.dbdd32509039cf99.53c8e:4.6946ba.f00f2542efe8.579.e1.]:6633#zZ}N52jBJ^2eA[(M^pgNAJ!Lz(UrdKz', 
                                address_1 = '', 
                                address_2 = '', 
                                address_3 = '', 
                                address_4 = '', 
    ...
    def testListFilings200Response(self):
        """Test ListFilings200Response"""
