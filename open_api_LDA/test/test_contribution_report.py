...
class TestContributionReport(unittest.TestCase):
    """ContributionReport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContributionReport:
        """Test ContributionReport
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContributionReport`
        """
    ...
    def testContributionReport(self):
        """Test ContributionReport"""
