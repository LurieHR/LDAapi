...
class TestListContributionReports200Response(unittest.TestCase):
    """ListContributionReports200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListContributionReports200Response:
        """Test ListContributionReports200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListContributionReports200Response`
        """
        model = ListContributionReports200Response()
        if include_optional:
            return ListContributionReports200Response(
                count = 123,
                next = '/api/v1/{operation}/?page=2',
                previous = '',
                results = [
                    openapi_client.models.contribution_report.ContributionReport(
                        url = '', 
                        filing_uuid = '', 
                        filing_type = 'MM', 
                        filing_type_display = '', 
                        ...
                        country = 'US', 
                        country_display = '', 
                        registrant = openapi_client.models.contribution_report_registrant.ContributionReport_registrant(
                            id = 56, 
                            url = '', 
                        ...
                        contribution_items = [
                            openapi_client.models.contribution_report_contribution_items_inner.ContributionReport_contribution_items_inner(
    ...
    def testListContributionReports200Response(self):
        """Test ListContributionReports200Response"""
